...
std::pair<uint64_t, bool> evaluate_x86(void *dr_context, instr_t *d_insn, ucontext_t *ucontext);

std::pair<uint64_t, bool> evaluate_arm(void *dr_context, instr_t *d_insn, ucontext_t *ucontext);
...
#define cancel_deferred() __deferrer.cancel();
#endif